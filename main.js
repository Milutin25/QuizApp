...
const questions = [
    {
        question: "Who was MVP of 2022/2023 NBA season",
        answers: ["Lebron James", "Nikola Jokic", "Kevin Durant", "Luka Doncic"],
        correct: 1
    },
    {
        question: "Who is the tennis GOAT?",
        answers: ["Marat Safin", "Ivan Lendl", "Boris Becker", "Novak Djokovic"],
        correct: 3
    },
    {
        question: "Select European Champions League winner for 1991",
        answers: ["Bayern Munich", "AC MIlan", "Red Star Belgrade", "Partizani Tirana"],
        correct: 2
    },
    {
        question: "100 meters World record belongs to?",
        answers: ["Usain Bolt", "Carl Lewis", "Slobodan Brankovic", "Wilson Boit Kipketer"],
        correct: 0
    }
];
